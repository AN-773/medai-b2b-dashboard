...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Matches Vue app logic: Response is JSON with "url" key containing the callback URL with token.
      ...
      if (redirectUrl) {
        ...
        throw new Error('Invalid response from server: No redirect URL');
      }
  ...
  return (
    <div className="min-h-screen flex bg-[#F3F6F3]">
      {/* Left Panel - Branding */}
      <div className="hidden xl:flex xl:w-1/2 bg-[#0F1110] relative overflow-hidden">
            ...
            <div className="space-y-4 pt-8 border-t border-slate-800">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold mb-1">
                    USMLE Content Intelligence
                  </h3>
                  <p className="text-sm text-slate-400">
                    Fully mapped to official content outline
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Item-level analytics and quality assurance
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Automated content authoring and review
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 xl:p-16">
        <div className="w-full max-w-md">
          {/* Mobile Logo */}
          <div className="xl:hidden flex items-center gap-3 mb-12 justify-center">
            ...
            <div>
              <h1 className="font-black text-slate-900 tracking-tight text-xl">
                MSAi®
              </h1>
          ...
          <div className="space-y-8">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#F3F6F3] text-slate-500 font-bold">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-slate-300 text-[#1BD183] focus:ring-[#1BD183]"
                  />
                ...
                <button
                  type="button"
                  className="text-sm text-[#1BD183] hover:text-[#15a36d] font-bold transition"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <div className="text-center space-y-4 pt-6 border-t border-slate-200">
              <p className="text-sm text-slate-600">
                ...
                <a
                  href="#"
                  className="text-[#1BD183] hover:text-[#15a36d] font-bold transition"
                >
